...
class Secp256k1KeyGenerator {
    ...
    private static readonly Gx = BigInt('0x79BE667EF9DCBBAC55A06295CE870B07029BFCDB2DCE28D959F2815B16F81798');
    private static readonly Gy = BigInt('0x483ADA7726A3C4655DA4FBFC0E1108A8FD17B448A68554199C47D08FFB10D4B8');
     ...
     */
    private static pointAdd(x1: bigint, y1: bigint, x2: bigint, y2: bigint): [bigint, bigint] {
        if (x1 === x2) {
            if (y1 === y2) {
                // Point doubling
     ...
     */
    private static scalarMult(k: bigint, x: bigint, y: bigint): [bigint, bigint] {
     ...
     */
    static generatePublicKey(privateKeyHex: string): string {
